# ===========================================================================
# adapters/database.py — Connection pool PostgreSQL (psycopg2)
#
# Fornisce un pool di connessioni riutilizzabili. Usato internamente da
# PostgresAdapter. Migrato da models/database.py con API migliorata.
# ===========================================================================
